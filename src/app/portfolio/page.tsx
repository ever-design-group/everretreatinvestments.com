...
export default function PortfolioPage() {
  return (
    <PageLayout
      title="Our Portfolio"
      subtitle="200+ villas built across Rwanda's most desirable locations. Ten years of exceptional craftsmanship in Rubavu, Musanze, Kigali, and Nyungwe."
      showCta={false}
    >
      <section className="relative h-[500px] w-full overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center px-4 sm:px-6 text-center">
          ...
          <p className="mt-4 sm:mt-6 max-w-2xl text-sm text-white/80 sm:text-base md:text-xl">
