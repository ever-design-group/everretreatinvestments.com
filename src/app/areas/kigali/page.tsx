              ...
              <div className="space-y-5 bg-brand-teal p-8 text-white">
                ...
                <div className="space-y-4 divide-y divide-white/10">
                  ...
                  <div className="pt-4">
                    ...
                    <p className="mt-1 text-sm font-semibold">{areaItems.kigali.description}</p>
                  </div>
                  <div className="pt-4">
