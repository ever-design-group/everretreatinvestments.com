...
const reasons = [
  ...
  {
    number: "02",
    title: "200+ Completed Retreats",
    description:
      "10+ years building across Rwanda. Visible, verifiable track record.",
  },
  {
    number: "03",
    title: "Award-Winning Eco-Architecture",
    description:
      "International Property Awards 2025. Featured in Forbes, CNN Africa, and The East African.",
  },
  {
    number: "04",
  ...
  },
  {
    ...
    description:
      "Offices in Kigali. Walk in and meet the team.",
  },
];

export function WhyEverRetreat() {
  return (
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
          <div>
            ...
            <h2 className="mt-4 text-3xl font-bold leading-tight text-black md:text-5xl md:leading-tight">
              Why Choose Ever Retreat Over Other Rwanda Developers?
            </h2>
            <p className="mt-6 text-base leading-relaxed text-brand-gray-600">
              ...
              are common. We exist because investors deserve better.
            </p>
